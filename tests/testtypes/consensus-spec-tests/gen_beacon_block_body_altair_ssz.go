...
var staticSizeCacheBeaconBlockBodyAltair = 96 + new(Eth1Data).SizeSSZ() + 32 + 4 + 4 + 4 + 4 + 4 + new(SyncAggregate).SizeSSZ()
...
func (obj *BeaconBlockBodyAltair) DefineSSZ(codec *ssz.Codec) {
