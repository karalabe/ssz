...
//go:generate go run -cover ../../../cmd/sszgen -type BeaconStateAltair -out gen_beacon_state_altair_ssz.go
//go:generate go run -cover ../../../cmd/sszgen -type BeaconStateBellatrix -out gen_beacon_state_bellatrix_ssz.go
