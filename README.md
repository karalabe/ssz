...
| `[N]byte` in `[]byte` |                                                                     [`DefineStaticBytesChecked`](https://pkg.go.dev/github.com/karalabe/ssz#DefineStaticBytesChecked)                                                                     |                                                                     [`EncodeStaticBytesChecked`](https://pkg.go.dev/github.com/karalabe/ssz#EncodeStaticBytesChecked)                                                                     |                                                                     [`DecodeStaticBytesChecked`](https://pkg.go.dev/github.com/karalabe/ssz#DecodeStaticBytesChecked)                                                                     |
